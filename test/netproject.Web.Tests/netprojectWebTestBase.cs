...
{
    public abstract class netprojectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static netprojectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(netprojectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<netprojectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<netprojectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<netprojectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<netprojectDbContext, Task<T>> func)
        {
            T result;
